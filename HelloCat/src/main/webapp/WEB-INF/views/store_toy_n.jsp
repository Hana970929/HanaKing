...
var page = 2; //불러올 페이지
function next_load_t_n() { 
	$.ajax({
		type:"GET",
		url:"HCController?command=infiniteScroll_t_n",
		data : {'page':page},
		dataType : "json",
...
<body bgcolor="#f1e6d3">
	...
	<div class="bestPd">
		...
		<div class="salesOrNew">
			<b>신상품순</b>&nbsp;|&nbsp;<a href="HCController?command=storetoy">인기순</a>
		</div>
	</div>
	...
	<div class="nomorePd">
		<button id="morePdbtn"style="width:100%; height:100%;" onclick="next_load_t_n()">
			상품 더 보기
		</button>
	</div>
</body>
