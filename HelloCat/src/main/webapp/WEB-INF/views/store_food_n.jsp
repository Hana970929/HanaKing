...
var page = 2; //불러올 페이지
function next_load_f_n() { 
	var command = "infiniteScroll_f_n";
	$.ajax({
		type:"GET",
		url:"HCController",
		...
		success: function(string) {
			...
			if(result.length<6) {
				for (var i=0;i<=result.length-1;i++) {
					...
					append_node += "</div>";
					append_node += "<h2><span class='textDark'>맛있겠냥</span></h2>";
...
<body bgcolor="#f1e6d3">
	...
	<div class="bestPd">
		...
		<div class="salesOrNew">
			<b>신상품순</b>&nbsp;|&nbsp;<a href="HCController?command=storefood">인기순</a>
		</div>
	</div>
	<div class="showThreePd divCenter" id="pdcontainer">
		...
		%>
			...
			<div class="pdImgDiv">
				...
				<h2><span class="textDark">맛있겠냥</span></h2>
	...
	<div class="nomorePd">
		<button id="morePdbtn"style="width:100%; height:100%;" onclick="next_load_f_n()">
			상품 더 보기
		</button>
	</div>
</body>
