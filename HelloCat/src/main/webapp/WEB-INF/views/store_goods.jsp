...
var page = 2; //불러올 페이지
function next_load_g() { 
	$.ajax({
		type:"GET",
		url:"HCController?command=infiniteScroll_g",
		data : {'page':page},
		dataType : "json",
...
<body bgcolor="#f1e6d3">
	...
	<div class="bestPd">
		...
		<div class="salesOrNew">
			<a href="HCController?command=storegoods_n">신상품순</a>&nbsp;|&nbsp;<b>인기순</b>
		</div>
	</div>
	...
	<div class="nomorePd">
		<button id="morePdbtn"style="width:100%; height:100%;" onclick="next_load_g()">
			상품 더 보기
		</button>
	</div>
</body>
