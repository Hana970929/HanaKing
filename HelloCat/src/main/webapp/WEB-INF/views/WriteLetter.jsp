...
<body style = "padding-bottom:30px;" bgcolor="#f1e6d3">
	<div class="basic">
	...
	<div class = "write_photo">	
		<div class = "wrph2">
				<form action = "HCController">
					<div id ="letter_write_title">
						<input type = "text" class = "letter_write_title" name = "letter_write_title" placeholder="제목을 입력해주세요"required>
					</div>	
					<div class = "textarea2">
						<textarea name="contents" id = "bpm2"placeholder="내용을 입력해주세요"required></textarea>
					</div>	
					<div class = "file">
						<span class = "sa">사진</span><input type = "file"  id="bpp" 
						name="bpp" accept="image/png, image/jpeg">
					...
					<div id = "photo_write_btn">
						<button type = "submit" class = "photo_write_btn" name = "command" value = "WriteLetter"><p class= "photo_write_btn_p">입력완료</p></button>
					</div>	
				</form>	
			</div>	
		</div>
